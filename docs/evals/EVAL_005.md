...
Report from trajectory `token_usage` in the run artifact (prompt / completion / total). Tokens inform **Cost per Verified Correct Outcome**; they do **not** gate ACCEPT.

| Field | Value |
|-------|--------|
| prompt / completion / total | See `EVAL_005_run.json` trajectory events |
